...
1. 발광 다이오드(LED)는 출력 구성요소입니다. 전류가 LED를 통해 흐르면 LED는 빛을 냅니다. 서로 다른 LED들은 다른 색의 빛을 낼 수 있고, 심지어 어떤 LED들은 여러 가지 색을 낼 수 있습니다.
...
1. 스위치는 회로를 여닫는 역할을 합니다. 스위치가 열리면, LED와 저항에 전류가 흐를 수 없습니다. 스위치가 닫히면 회로가 완성돼 전류가 흐르게 되어 LED가 켜지게 됩니다.
